...
public:
    ...
    void follow(int userId1, int userId2) {
        // Implement this
        if (users.find(userId1) == users.end()) addUser(userId1);
        if (users.find(userId2) == users.end()) addUser(userId2);
    ...
    void unfollow(int userId1, int userId2) {
        // Implement this
        if (users.find(userId1) == users.end() || users.find(userId2) == users.end()) return;  
        if (following[userId1].find(userId2) != following[userId1].end()) {
    ...
    vector<int> getFollowers(int userId) {
        // Implement this
        if (users.find(userId) == users.end()) return {};  
        vector<int> result(followers[userId].begin(), followers[userId].end());
    ...
    vector<int> getFollowing(int userId) {
        ...
        vector<int> result(following[userId].begin(), following[userId].end());
        sort(result.begin(), result.end());
        return result;
    }
    ...
    bool isFollowing(int userId1, int userId2) {
        ...
        return following[userId1].find(userId2) != following[userId1].end(); // placeholder
    }
